...
` + i[a].replace(
        ...
        J = !1, p.H = n, c(), Error.prepareStackTrace = t;
      }
      return i = (i = e ? e.displayName || e.name : "") ? l(i) : "", typeof e == "function" && q.set(e, i), i;
    }
    function R(e) {
      if (e == null) return "";
      if (typeof e == "function") {
...
const H = class H extends he.PureComponent {
  constructor() {
    super(...arguments), this.canvas = null, this.handleRef = (d) => {
      ...
      if (this.canvas) {
        const c = Ae(d, s ?? 128, f ?? 128, g ?? 1), l = this.canvas.getContext("2d");
        if (l) {
          const v = l.createImageData(s ?? 128, f ?? 128);
          v.data.set(c), l.putImageData(v, 0, 0);
        }
      }
    };
  }
